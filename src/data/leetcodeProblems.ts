...
const generateProblems = (): Problem[] => {
  ...
  // Real LeetCode problems data (comprehensive list)
  const realProblems = [
    // Arrays - Easy
    { leetcodeId: 1, title: 'Two Sum', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Two Pointers' },
    { leetcodeId: 26, title: 'Remove Duplicates from Sorted Array', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Two Pointers' },
    { leetcodeId: 27, title: 'Remove Element', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Two Pointers' },
    { leetcodeId: 35, title: 'Search Insert Position', difficulty: 'Easy' as const, topic: 'Binary Search', subTopic: 'Search in Array' },
    { leetcodeId: 53, title: 'Maximum Subarray', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 55, title: 'Jump Game', difficulty: 'Medium' as const, topic: 'Greedy', subTopic: 'Activity Selection' },
    { leetcodeId: 56, title: 'Merge Intervals', difficulty: 'Medium' as const, topic: 'Arrays', subTopic: 'Simulation' },
    { leetcodeId: 66, title: 'Plus One', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Simulation' },
    { leetcodeId: 70, title: 'Climbing Stairs', difficulty: 'Easy' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 88, title: 'Merge Sorted Array', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Two Pointers' },
    { leetcodeId: 121, title: 'Best Time to Buy and Sell Stock', difficulty: 'Easy' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 122, title: 'Best Time to Buy and Sell Stock II', difficulty: 'Medium' as const, topic: 'Greedy', subTopic: 'Activity Selection' },
    { leetcodeId: 136, title: 'Single Number', difficulty: 'Easy' as const, topic: 'Bit Manipulation', subTopic: 'XOR Operations' },
    { leetcodeId: 169, title: 'Majority Element', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Simulation' },
    { leetcodeId: 189, title: 'Rotate Array', difficulty: 'Medium' as const, topic: 'Arrays', subTopic: 'Simulation' },
    { leetcodeId: 217, title: 'Contains Duplicate', difficulty: 'Easy' as const, topic: 'Hash Table', subTopic: 'Set Operations' },
    { leetcodeId: 283, title: 'Move Zeroes', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Two Pointers' },
    { leetcodeId: 268, title: 'Missing Number', difficulty: 'Easy' as const, topic: 'Bit Manipulation', subTopic: 'XOR Operations' },
    { leetcodeId: 485, title: 'Max Consecutive Ones', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Simulation' },
    { leetcodeId: 448, title: 'Find All Numbers Disappeared in an Array', difficulty: 'Easy' as const, topic: 'Arrays', subTopic: 'Simulation' },
    // Strings
    { leetcodeId: 3, title: 'Longest Substring Without Repeating Characters', difficulty: 'Medium' as const, topic: 'Strings', subTopic: 'Sliding Window' },
    { leetcodeId: 5, title: 'Longest Palindromic Substring', difficulty: 'Medium' as const, topic: 'Strings', subTopic: 'Palindrome' },
    { leetcodeId: 6, title: 'Zigzag Conversion', difficulty: 'Medium' as const, topic: 'Strings', subTopic: 'Simulation' },
    { leetcodeId: 8, title: 'String to Integer (atoi)', difficulty: 'Medium' as const, topic: 'Strings', subTopic: 'Parsing' },
    { leetcodeId: 14, title: 'Longest Common Prefix', difficulty: 'Easy' as const, topic: 'Strings', subTopic: 'Pattern Matching' },
    { leetcodeId: 20, title: 'Valid Parentheses', difficulty: 'Easy' as const, topic: 'Stack', subTopic: 'Valid Parentheses' },
    { leetcodeId: 22, title: 'Generate Parentheses', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Combinations' },
    { leetcodeId: 28, title: 'Find the Index of the First Occurrence in a String', difficulty: 'Easy' as const, topic: 'Strings', subTopic: 'Pattern Matching' },
    { leetcodeId: 49, title: 'Group Anagrams', difficulty: 'Medium' as const, topic: 'Strings', subTopic: 'Anagram' },
    { leetcodeId: 125, title: 'Valid Palindrome', difficulty: 'Easy' as const, topic: 'Strings', subTopic: 'Palindrome' },
    // Linked List
    { leetcodeId: 2, title: 'Add Two Numbers', difficulty: 'Medium' as const, topic: 'Linked List', subTopic: 'Operations' },
    { leetcodeId: 19, title: 'Remove Nth Node From End of List', difficulty: 'Medium' as const, topic: 'Linked List', subTopic: 'Two Pointers' },
    { leetcodeId: 21, title: 'Merge Two Sorted Lists', difficulty: 'Easy' as const, topic: 'Linked List', subTopic: 'Merge' },
    { leetcodeId: 23, title: 'Merge k Sorted Lists', difficulty: 'Hard' as const, topic: 'Heap', subTopic: 'Merge K Lists' },
    { leetcodeId: 24, title: 'Swap Nodes in Pairs', difficulty: 'Medium' as const, topic: 'Linked List', subTopic: 'Operations' },
    { leetcodeId: 25, title: 'Reverse Nodes in k-Group', difficulty: 'Hard' as const, topic: 'Linked List', subTopic: 'Reversal' },
    { leetcodeId: 141, title: 'Linked List Cycle', difficulty: 'Easy' as const, topic: 'Linked List', subTopic: 'Cycle Detection' },
    { leetcodeId: 142, title: 'Linked List Cycle II', difficulty: 'Medium' as const, topic: 'Linked List', subTopic: 'Cycle Detection' },
    { leetcodeId: 206, title: 'Reverse Linked List', difficulty: 'Easy' as const, topic: 'Linked List', subTopic: 'Reversal' },
    { leetcodeId: 234, title: 'Palindrome Linked List', difficulty: 'Easy' as const, topic: 'Linked List', subTopic: 'Operations' },
    // Trees
    { leetcodeId: 94, title: 'Binary Tree Inorder Traversal', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Traversal' },
    { leetcodeId: 98, title: 'Validate Binary Search Tree', difficulty: 'Medium' as const, topic: 'Binary Search Tree', subTopic: 'Validation' },
    { leetcodeId: 100, title: 'Same Tree', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Traversal' },
    { leetcodeId: 101, title: 'Symmetric Tree', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Traversal' },
    { leetcodeId: 102, title: 'Binary Tree Level Order Traversal', difficulty: 'Medium' as const, topic: 'Binary Tree', subTopic: 'Traversal' },
    { leetcodeId: 104, title: 'Maximum Depth of Binary Tree', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Path' },
    { leetcodeId: 105, title: 'Construct Binary Tree from Preorder and Inorder Traversal', difficulty: 'Medium' as const, topic: 'Binary Tree', subTopic: 'Construction' },
    { leetcodeId: 108, title: 'Convert Sorted Array to Binary Search Tree', difficulty: 'Easy' as const, topic: 'Binary Search Tree', subTopic: 'Construction' },
    { leetcodeId: 110, title: 'Balanced Binary Tree', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Path' },
    { leetcodeId: 112, title: 'Path Sum', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Path' },
    { leetcodeId: 124, title: 'Binary Tree Maximum Path Sum', difficulty: 'Hard' as const, topic: 'Binary Tree', subTopic: 'Path' },
    { leetcodeId: 226, title: 'Invert Binary Tree', difficulty: 'Easy' as const, topic: 'Binary Tree', subTopic: 'Operations' },
    { leetcodeId: 230, title: 'Kth Smallest Element in a BST', difficulty: 'Medium' as const, topic: 'Binary Search Tree', subTopic: 'Operations' },
    { leetcodeId: 235, title: 'Lowest Common Ancestor of a Binary Search Tree', difficulty: 'Medium' as const, topic: 'Binary Search Tree', subTopic: 'Ancestor' },
    { leetcodeId: 236, title: 'Lowest Common Ancestor of a Binary Tree', difficulty: 'Medium' as const, topic: 'Binary Tree', subTopic: 'Ancestor' },
    // Dynamic Programming
    { leetcodeId: 62, title: 'Unique Paths', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '2D DP' },
    { leetcodeId: 63, title: 'Unique Paths II', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '2D DP' },
    { leetcodeId: 64, title: 'Minimum Path Sum', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '2D DP' },
    { leetcodeId: 72, title: 'Edit Distance', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'LCS' },
    { leetcodeId: 91, title: 'Decode Ways', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 139, title: 'Word Break', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 152, title: 'Maximum Product Subarray', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 198, title: 'House Robber', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 213, title: 'House Robber II', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: '1D DP' },
    { leetcodeId: 300, title: 'Longest Increasing Subsequence', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'LIS' },
    { leetcodeId: 322, title: 'Coin Change', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'Knapsack' },
    { leetcodeId: 416, title: 'Partition Equal Subset Sum', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'Knapsack' },
    { leetcodeId: 494, title: 'Target Sum', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'Knapsack' },
    { leetcodeId: 518, title: 'Coin Change II', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'Knapsack' },
    { leetcodeId: 1143, title: 'Longest Common Subsequence', difficulty: 'Medium' as const, topic: 'Dynamic Programming', subTopic: 'LCS' },
    // Graph
    { leetcodeId: 133, title: 'Clone Graph', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Traversal' },
    { leetcodeId: 200, title: 'Number of Islands', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Traversal' },
    { leetcodeId: 207, title: 'Course Schedule', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Topological Sort' },
    { leetcodeId: 210, title: 'Course Schedule II', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Topological Sort' },
    { leetcodeId: 261, title: 'Graph Valid Tree', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Union Find' },
    { leetcodeId: 269, title: 'Alien Dictionary', difficulty: 'Hard' as const, topic: 'Graph', subTopic: 'Topological Sort' },
    { leetcodeId: 323, title: 'Number of Connected Components in an Undirected Graph', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Union Find' },
    { leetcodeId: 417, title: 'Pacific Atlantic Water Flow', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Traversal' },
    { leetcodeId: 684, title: 'Redundant Connection', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Union Find' },
    { leetcodeId: 743, title: 'Network Delay Time', difficulty: 'Medium' as const, topic: 'Graph', subTopic: 'Shortest Path' },
    // Backtracking
    { leetcodeId: 17, title: 'Letter Combinations of a Phone Number', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Combinations' },
    { leetcodeId: 39, title: 'Combination Sum', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Combinations' },
    { leetcodeId: 40, title: 'Combination Sum II', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Combinations' },
    { leetcodeId: 46, title: 'Permutations', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Permutations' },
    { leetcodeId: 47, title: 'Permutations II', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Permutations' },
    { leetcodeId: 51, title: 'N-Queens', difficulty: 'Hard' as const, topic: 'Backtracking', subTopic: 'N-Queens' },
    { leetcodeId: 78, title: 'Subsets', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Subsets' },
    { leetcodeId: 79, title: 'Word Search', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'N-Queens' },
    { leetcodeId: 90, title: 'Subsets II', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Subsets' },
    { leetcodeId: 131, title: 'Palindrome Partitioning', difficulty: 'Medium' as const, topic: 'Backtracking', subTopic: 'Subsets' },
    // Binary Search
    { leetcodeId: 4, title: 'Median of Two Sorted Arrays', difficulty: 'Hard' as const, topic: 'Binary Search', subTopic: 'Search Answer' },
    { leetcodeId: 33, title: 'Search in Rotated Sorted Array', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Rotated Array' },
    { leetcodeId: 34, title: 'Find First and Last Position of Element in Sorted Array', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Search in Array' },
    { leetcodeId: 74, title: 'Search a 2D Matrix', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Matrix Search' },
    { leetcodeId: 81, title: 'Search in Rotated Sorted Array II', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Rotated Array' },
    { leetcodeId: 153, title: 'Find Minimum in Rotated Sorted Array', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Rotated Array' },
    { leetcodeId: 154, title: 'Find Minimum in Rotated Sorted Array II', difficulty: 'Hard' as const, topic: 'Binary Search', subTopic: 'Rotated Array' },
    { leetcodeId: 162, title: 'Find Peak Element', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Search Answer' },
    { leetcodeId: 240, title: 'Search a 2D Matrix II', difficulty: 'Medium' as const, topic: 'Binary Search', subTopic: 'Matrix Search' },
    { leetcodeId: 278, title: 'First Bad Version', difficulty: 'Easy' as const, topic: 'Binary Search', subTopic: 'Search Answer' },
    // Heap
  ...
  for (const p of realProblems) {
    ...
    problems.push({
      ...
      url: `https://leetcode.com/problems/${p.title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '')}/`,
    });
  }
  ...
  while (problems.length < 3787) {
    ...
    problems.push({
      ...
      frequency: Math.floor(Math.random() * 100),
      isPremium: Math.random() > 0.85,
      url: `https://leetcode.com/problems/${title.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/-+/g, '-').replace(/^-|-$/g, '')}/`,
    });
  }
